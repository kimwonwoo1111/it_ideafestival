...
const mockPosts: Post[] = [
  {
    ...
    comments: [
      ...
      },
      {
        id: 2,
        username: "투자자K",
        text: "실제 증권거래소 데이터를 확인한 결과 거래량이 크게 증가했습니다.",
        timeAgo: "2시간 전",
        upvotes: 189,
        type: "support",
        evidenceType: "image",
...
export default function App() {
  ...
  const myFactsPosts = mockPosts.slice(0, 3).map((post) => ({
    id: post.id,
        ...
        <div className="w-full max-w-2xl">
          <div className="relative">
            <input
              ...
              placeholder="새로운 사실을 물어보세요."
              className="w-full px-6 py-4 pr-12 rounded-full border-2 border-gray-200 focus:border-purple-500 focus:outline-none transition-all shadow-lg hover:shadow-xl"
            />
